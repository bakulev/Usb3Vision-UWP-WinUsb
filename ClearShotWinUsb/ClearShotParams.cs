...
namespace Centice.Spectrometry.Spectrometers.Cameras
{
    ...
    public class ClearShotParams : IParamStorage
    {
        #region Variables
        ...
        {
            return DeviceCalibration.LaserWavelength;
        }
        ...
        SpectrometerCalibration IParamStorage.DeviceCalibration => throw new NotImplementedException();
        ...
        /* this method should replace previous methods
        #region IParamStorage members

        SpectrometerCalibration DeviceCalibration;

        public byte[] GetCalibrationByteArray()
        {
            string strCalibration;
            UploadCalibration(out strCalibration);
        ...
        {
            var calibrationParameters = new CalibrationParameters();
            var image = calibrationParameters.GetImage(exposure, temperature);
            return image; // new ushort[ImageSize.Height, ImageSize.Width];
        }
        ...
        */
        ...
        #region methods from ClearShotWinUsb
        ...
        public async Task<string> UploadCalibration()
        {
            ...
            //if (!IsOpen)
            //{
            //    throw new ApplicationException("Camera is not open.");
            //}
            ...
            //lock (m_CameraLock)
            {
                ...
                {
                    return await _device.GetCalibration();
                });
                calibration = task.Result;
                calibration = calibration.TrimEnd(new char[] { '\r', '\n', ' ' });
            }
